...
## Project Structure
    ...
    ├── testapiautocatalog_118540  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_118540`
...
2. Clone this repo and `cd testapiautocatalog_118540`
